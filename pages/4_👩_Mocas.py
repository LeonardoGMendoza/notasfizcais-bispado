...
st.markdown("""
    <div class="custom-card">
        Acompanhamento das classes das Moças. Aqui registramos nossa preocupação e amor por elas, garantindo que se sintam acolhidas.
    </div>
...
if df.empty:
    st.info("Nenhuma jovem cadastrada ainda.")
else:
